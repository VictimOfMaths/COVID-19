...
data <- read_excel(temp, sheet="Figure 57&58. COVID Vac Age Sex", range="B13:N26", col_names=FALSE) %>% 
...
mergeddata <- dataw20 %>% mutate(Week=20) %>% 
  bind_rows(dataw19 %>% mutate(Week=19)) %>% 
