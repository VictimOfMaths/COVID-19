...
admurl <- "https://www.england.nhs.uk/statistics/wp-content/uploads/sites/2/2021/09/Weekly-covid-admissions-and-beds-publication-210916.xlsx"

#Increment by 7 when each new report is published
admrange <- "FG"
#Set latest date of admissions data
admdate <- as.Date("2021-09-12")
