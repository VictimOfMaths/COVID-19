...
admurl <- "https://www.england.nhs.uk/statistics/wp-content/uploads/sites/2/2021/06/Weekly-covid-admissions-and-beds-publication-210603.xlsx"

#Increment by 7 when each new report is published
admrange <- "BF"
#Set latest date of admissions data
admdate <- as.Date("2021-05-30")
...
plot1 <- ggplot()+
  ...
  labs(title="COVID admission rates are highest in Lancashire and the West Midlands",
